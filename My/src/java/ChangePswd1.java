...
public class ChangePswd1 extends HttpServlet {
	...
	String newpwd=request.getParameter("pwd1");	
	 ...
	 if (EMAIL_ID!= null)
		 {
         int i=stmt.executeUpdate("update USERS_INFO set PASSWORD='"+newpwd+"' where  PASSWORD='"+prepwd+"'");
		 if(i>0)
		 {
		 ...
		 out.println("<body>");	
		 out.println("<center><br><font size=5 color=#2271A0><a href='Login1.jsp' target=\"_top\">Login page </a></center>");
                 out.println ("</body>");
		 out.println("</html>");
		}
		 else
